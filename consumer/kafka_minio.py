...
try:
    ...
    print(f"✅ Consumer initialized with bootstrap servers: {os.getenv('KAFKA_BOOTSTRAP')}")
...
print(f"DEBUG: MINIO_BUCKET={os.getenv('MINIO_BUCKET')}")
s3 = boto3.client(
    's3',
...
# Batch consume
batch_size = 1  # Reduced to 1 for better visibility during debugging
buffer = {
    'banking_server.public.customers': [],
    'banking_server.public.accounts': [],
    'banking_server.public.transactions': []
